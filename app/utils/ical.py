...
def _build_summary(tour_stop, tour=None):
    ...
    type_labels = {
        ...
        EventType.PRIVATE_EVENT: '🎩 Événement privé',
        EventType.REHEARSAL: '🎸 Répétition',
        EventType.RECORDING: '🎙️ Enregistrement',
        EventType.INTERVIEW: '🎤 Interview',
        EventType.PHOTOSHOOT: '📸 Photoshoot',
...
def _get_event_category(tour_stop):
    ...
    categories = {
        EventType.SHOW: 'CONCERT',
        EventType.FESTIVAL: 'FESTIVAL',
        EventType.PRIVATE_EVENT: 'PRIVATE',
        EventType.REHEARSAL: 'REHEARSAL',
        EventType.RECORDING: 'RECORDING',
        EventType.INTERVIEW: 'PRESS',
        EventType.PHOTOSHOOT: 'PRESS',
